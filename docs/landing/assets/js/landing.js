...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const COORDS = {
    'gradle-kts': {
      copy: 'implementation("com.integrallis:vectors:0.1.22")',
      show: 'implementation("com.integrallis:vectors:0.1.22")',
    },
    'gradle-groovy': {
      copy: "implementation 'com.integrallis:vectors:0.1.22'",
      show: "implementation 'com.integrallis:vectors:0.1.22'",
    ...
    sbt: {
      copy: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.22"',
      show: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.22"',
    },
  };
