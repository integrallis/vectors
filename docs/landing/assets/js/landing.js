...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const COORDS = {
    'gradle-kts': {
      copy: 'implementation("com.integrallis:vectors:0.1.14")',
      show: 'implementation("com.integrallis:vectors:0.1.14")',
    },
    'gradle-groovy': {
      copy: "implementation 'com.integrallis:vectors:0.1.14'",
      show: "implementation 'com.integrallis:vectors:0.1.14'",
    ...
    sbt: {
      copy: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.14"',
      show: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.14"',
    },
  };
