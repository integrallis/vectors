...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const COORDS = {
    'gradle-kts': {
      copy: 'implementation("com.integrallis:vectors:0.1.11")',
      show: 'implementation("com.integrallis:vectors:0.1.11")',
    },
    'gradle-groovy': {
      copy: "implementation 'com.integrallis:vectors:0.1.11'",
      show: "implementation 'com.integrallis:vectors:0.1.11'",
    ...
    sbt: {
      copy: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.11"',
      show: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.11"',
    },
  };
