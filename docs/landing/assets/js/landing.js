...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const COORDS = {
    'gradle-kts': {
      copy: 'implementation("com.integrallis:vectors:0.1.21")',
      show: 'implementation("com.integrallis:vectors:0.1.21")',
    },
    'gradle-groovy': {
      copy: "implementation 'com.integrallis:vectors:0.1.21'",
      show: "implementation 'com.integrallis:vectors:0.1.21'",
    ...
    sbt: {
      copy: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.21"',
      show: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.21"',
    },
  };
