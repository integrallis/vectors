...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const COORDS = {
    'gradle-kts': {
      copy: 'implementation("com.integrallis:vectors:0.1.2")',
      show: 'implementation("com.integrallis:vectors:0.1.2")',
    },
    'gradle-groovy': {
      copy: "implementation 'com.integrallis:vectors:0.1.2'",
      show: "implementation 'com.integrallis:vectors:0.1.2'",
    ...
    sbt: {
      copy: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.2"',
      show: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.2"',
    },
  };
