...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const COORDS = {
    'gradle-kts': {
      copy: 'implementation("com.integrallis:vectors:0.1.15")',
      show: 'implementation("com.integrallis:vectors:0.1.15")',
    },
    'gradle-groovy': {
      copy: "implementation 'com.integrallis:vectors:0.1.15'",
      show: "implementation 'com.integrallis:vectors:0.1.15'",
    ...
    sbt: {
      copy: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.15"',
      show: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.15"',
    },
  };
