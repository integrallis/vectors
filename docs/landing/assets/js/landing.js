...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const COORDS = {
    'gradle-kts': {
      copy: 'implementation("com.integrallis:vectors:0.1.1")',
      show: 'implementation("com.integrallis:vectors:0.1.1")',
    },
    'gradle-groovy': {
      copy: "implementation 'com.integrallis:vectors:0.1.1'",
      show: "implementation 'com.integrallis:vectors:0.1.1'",
    ...
    sbt: {
      ...
      show: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.1"',
    },
  };
