...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const COORDS = {
    'gradle-kts': {
      copy: 'implementation("com.integrallis:vectors:0.1.23")',
      show: 'implementation("com.integrallis:vectors:0.1.23")',
    },
    'gradle-groovy': {
      copy: "implementation 'com.integrallis:vectors:0.1.23'",
      show: "implementation 'com.integrallis:vectors:0.1.23'",
    ...
    sbt: {
      copy: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.23"',
      show: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.23"',
    },
  };
