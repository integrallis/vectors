...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const COORDS = {
    'gradle-kts': {
      copy: 'implementation("com.integrallis:vectors:0.1.20")',
      show: 'implementation("com.integrallis:vectors:0.1.20")',
    },
    'gradle-groovy': {
      copy: "implementation 'com.integrallis:vectors:0.1.20'",
      show: "implementation 'com.integrallis:vectors:0.1.20'",
    ...
    sbt: {
      copy: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.20"',
      show: 'libraryDependencies += "com.integrallis" % "vectors" % "0.1.20"',
    },
  };
